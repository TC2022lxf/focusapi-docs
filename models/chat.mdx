...
- OpenAI SDK / LiteLLM：使用 OpenAI 兼容地址 `https://api.focusapi.cn/v1`
- Claude SDK：使用 Anthropic 原生地址 `https://api.focusapi.cn`
- Gemini SDK：使用 Gemini 原生地址 `https://api.focusapi.cn`
